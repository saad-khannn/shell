Description:
This shell is a simple Unix/Linux shell. It can accept 8 built-in commands through user input and can execute any of the built-in commands.
The shell is an interactive loop and will continue receiving inputs until the user enters in a quit command to end the loop and program.
